...
"""autogenerated by genpy from openlane_bag/LaneList.msg. Do not edit."""
import codecs
import sys
...
float32 visibility"""
  ...
  _slot_types = ['std_msgs/Header','openlane_bag/Lane[]','int32']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = openlane_bag.msg.Lane()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.lane = []
        for i in range(0, length):
          val2 = openlane_bag.msg.LanePoint()
          _x = val2
          start = end
          end += 16
