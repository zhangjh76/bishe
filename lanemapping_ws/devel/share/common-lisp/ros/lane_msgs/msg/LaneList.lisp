...
(cl:defclass <LaneList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (lane_list
    :reader lane_list
    :initarg :lane_list
    :type (cl:vector lane_msgs-msg:Lane)
   :initform (cl:make-array 0 :element-type 'lane_msgs-msg:Lane :initial-element (cl:make-instance 'lane_msgs-msg:Lane)))
   (num_lanes
    :reader num_lanes
    :initarg :num_lanes
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <LaneList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lane_msgs-msg:<LaneList> is deprecated: use lane_msgs-msg:LaneList instead.")))
...
(cl:defmethod lane_list-val ((m <LaneList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_msgs-msg:lane_list-val is deprecated.  Use lane_msgs-msg:lane_list instead.")
  (lane_list m))

(cl:ensure-generic-function 'num_lanes-val :lambda-list '(m))
(cl:defmethod num_lanes-val ((m <LaneList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_msgs-msg:num_lanes-val is deprecated.  Use lane_msgs-msg:num_lanes instead.")
  (num_lanes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaneList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lane_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lane_msgs-msg:Lane))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LaneList>)))
  ...
  (cl:format cl:nil "Header header~%Lane[] lane_list~%int32 num_lanes~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: lane_msgs/Lane~%LanePoint[] lane~%int32 num_points~%int32 attribute  # attribute: the left-left lane is 1, the left lane is 2, the right lane is 3, and the right-right lane is 4.~%int32 track_id~%int32 category~%~%================================================================================~%MSG: lane_msgs/LanePoint~%float32 x~%float32 y~%float32 z~%float32 visibility~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LaneList)))
  "Returns full string definition for message of type 'LaneList"
  (cl:format cl:nil "Header header~%Lane[] lane_list~%int32 num_lanes~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: lane_msgs/Lane~%LanePoint[] lane~%int32 num_points~%int32 attribute  # attribute: the left-left lane is 1, the left lane is 2, the right lane is 3, and the right-right lane is 4.~%int32 track_id~%int32 category~%~%================================================================================~%MSG: lane_msgs/LanePoint~%float32 x~%float32 y~%float32 z~%float32 visibility~%~%"))
