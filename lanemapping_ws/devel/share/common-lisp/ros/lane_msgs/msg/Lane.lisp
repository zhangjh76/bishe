...
(cl:defclass <Lane> (roslisp-msg-protocol:ros-message)
  ((lane
    :reader lane
    :initarg :lane
    :type (cl:vector lane_msgs-msg:LanePoint)
   :initform (cl:make-array 0 :element-type 'lane_msgs-msg:LanePoint :initial-element (cl:make-instance 'lane_msgs-msg:LanePoint)))
   (num_points
    :reader num_points
    :initarg :num_points
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <Lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lane_msgs-msg:<Lane> is deprecated: use lane_msgs-msg:Lane instead.")))

(cl:ensure-generic-function 'lane-val :lambda-list '(m))
(cl:defmethod lane-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_msgs-msg:lane-val is deprecated.  Use lane_msgs-msg:lane instead.")
  (lane m))

(cl:ensure-generic-function 'num_points-val :lambda-list '(m))
(cl:defmethod num_points-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_msgs-msg:num_points-val is deprecated.  Use lane_msgs-msg:num_points instead.")
  (num_points m))

(cl:ensure-generic-function 'attribute-val :lambda-list '(m))
(cl:defmethod attribute-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_msgs-msg:attribute-val is deprecated.  Use lane_msgs-msg:attribute instead.")
  (attribute m))

(cl:ensure-generic-function 'track_id-val :lambda-list '(m))
(cl:defmethod track_id-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_msgs-msg:track_id-val is deprecated.  Use lane_msgs-msg:track_id instead.")
  (track_id m))

(cl:ensure-generic-function 'category-val :lambda-list '(m))
(cl:defmethod category-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_msgs-msg:category-val is deprecated.  Use lane_msgs-msg:category instead.")
  (category m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Lane>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lane)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lane_msgs-msg:LanePoint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Lane>)))
  ...
  (cl:format cl:nil "LanePoint[] lane~%int32 num_points~%int32 attribute  # attribute: the left-left lane is 1, the left lane is 2, the right lane is 3, and the right-right lane is 4.~%int32 track_id~%int32 category~%~%================================================================================~%MSG: lane_msgs/LanePoint~%float32 x~%float32 y~%float32 z~%float32 visibility~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Lane)))
  "Returns full string definition for message of type 'Lane"
  (cl:format cl:nil "LanePoint[] lane~%int32 num_points~%int32 attribute  # attribute: the left-left lane is 1, the left lane is 2, the right lane is 3, and the right-right lane is 4.~%int32 track_id~%int32 category~%~%================================================================================~%MSG: lane_msgs/LanePoint~%float32 x~%float32 y~%float32 z~%float32 visibility~%~%"))
